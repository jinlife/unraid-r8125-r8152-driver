...
# Compile r8126 Kernel Module and install it to the temporary directory "/RTL8126"
cd ${DATA_DIR}/unraid-r8125-r8152-driver/r8126/src

# Compile Kernel Module and move it to a temporary directory
make -j${CPU_COUNT}
make INSTALL_MOD_PATH=/RTL8126 install -j${CPU_COUNT}

# Remove non Kernel modules from temporary directory
rm /RTL8126/lib/modules/${UNAME}/* 2>/dev/null
...
cd ${DATA_DIR}/unraid-r8125-r8152-driver/r8127/src
